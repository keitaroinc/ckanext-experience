...
experience = Blueprint(u'experience', __name__)
...
def new(self, data=None, errors=None, error_summary=None):
    ...
    return super(experience, self).new(data=data, errors=errors,
...
def edit(self, id, data=None, errors=None, error_summary=None):
    ...
    return super(experience, self).edit(
...
def _save_new(self, context, package_type=None):
    ...
    url = h.url_for(
        'ckanext.experience.views.experience.manage_datasets', id=pkg_dict['name'])
    redirect(url)
...
def _save_edit(self, name_or_id, context, package_type=None):
    ...
    url = h.url_for(
        'ckanext.experience.views.experience.experience.read',
        id=pkg['name'])
    redirect(url)
...
def delete(self, id):
    if 'cancel' in request.params:
        tk.redirect_to(
           'ckanext.experience.views.experience.edit', id=id)
    ...
    try:
        if request.method == 'POST':
            ...
            tk.redirect_to(
               'ckanext.experience.views.experience.search')
...
def dataset_experience_list(self, id):
    ...
    if request.method == 'POST':
        ...
        redirect(h.url_for(
            'ckanext.experience.views.experience.experience.dataset_experience_list',
            id=c.pkg_dict['name']))
        ...
        if dataset_ids:
            ...
            h.flash_success(
                ungettext(
                    ...
                    len(dataset_ids)))
            url = h.url_for(
                'ckanext.experience.views.experience.experience.manage_datasets', id=id)
            redirect(url)
            ...
            if successful_adds:
                h.flash_success(
                    ungettext(
                        ...
                        len(successful_adds)))
            url = h.url_for(
               'ckanext.experience.views.experience.manage_datasets',
                 id=id)
            redirect(url)
...
def _search_url(self, params, name):
    url = h.url_for(
       'ckanext.experience.views.experience.manage_datasets', id=name)
...
def _add_dataset_search(self, experience_id, experience_name):
    ...
    def drill_down_url(alternative_url=None, **by):
        return h.add_url_param('package.search',new_params=by,alternative_url=alternative_url)

    c.drill_down_url = drill_down_url

    def remove_field(key, value=None, replace=None):
        return h.remove_url_param('package.search', key, value=value, replace=replace)
...
experience.add_url_rule(u'/experience/new', view_func=new)    
experience.add_url_rule(u'/experience/edit', view_func=edit)    
experience.add_url_rule(u'/experience/delete', view_func=delete, methods=[u'GET', u'POST'])  
